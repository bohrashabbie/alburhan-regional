          ...
          {ordered.map((c, idx) => {
            ...
            return (
              <Link
                key={c.id}
                href={`/${slug}` as never}
                className="group relative grid grid-cols-[1fr_auto] items-center gap-6 border-b border-line py-7 md:grid-cols-[7rem_1fr_14rem_auto] md:gap-8"
                style={{
                  opacity: visible ? 1 : 0,
              ...
              >
                ...
                <div className="md:col-span-1">
                  <span className="t-mono block text-[0.5625rem] text-ink-4">
                    {slug.toUpperCase()}
                  </span>
